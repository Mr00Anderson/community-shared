package com.nogenericgames.community.arrays.ints;

import java.util.Arrays;

/**
 * Represents a six-dimensional array of integers.
 */
public class Int6DArray {
    ...
    /**
     * Constructs a 6D IntArray with the specified dimensions.
     *
     ...
     */
    public Int6DArray(int xSize, int ySize, int zSize, int wSize, int uSize, int vSize) {
     ...
     * @return The integer value at (x, y, z, w, u, v).
     * @throws IndexOutOfBoundsException if coordinates are out of bounds.
     */
    public int get(int x, int y, int z, int w, int u, int v) {
     ...
     * @throws IndexOutOfBoundsException if coordinates are out of bounds.
     */
    public void set(int x, int y, int z, int w, int u, int v, int value) {
        checkBounds(x, y, z, w, u, v);
     ...
     * @return The integer value at (x, y, z, w, u, v).
     */
    public int getUnsafe(int x, int y, int z, int w, int u, int v) {
        return data[(x * ySize * zSize * wSize * uSize * vSize) +
                    (y * zSize * wSize * uSize * vSize) +
                    (z * wSize * uSize * vSize) +
                    (w * uSize * vSize) +
     ...
     * @param value The integer value to set.
     */
    public void setUnsafe(int x, int y, int z, int w, int u, int v, int value) {
        data[(x * ySize * zSize * wSize * uSize * vSize) +
             (y * zSize * wSize * uSize * vSize) +
             (z * wSize * uSize * vSize) +
             (w * uSize * vSize) +
     ...
     *
     * @return A new integer array containing the data.
     */
    public int[] getData() {
        return data.clone();
    }
    ...
    /**
     * Creates a copy of this Int6DArray.
     *
     * @return A new Int6DArray instance with copied data.
     */
    public Int6DArray copy() {
        Int6DArray copy = new Int6DArray(xSize, ySize, zSize, wSize, uSize, vSize);
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Int6DArray{\n");
