...
/**
 * Represents a five-dimensional array of integers.
 */
public class Int5DArray {
    ...
    /**
     * Constructs a 5D IntArray with the specified dimensions.
     *
     ...
     */
    public Int5DArray(int xSize, int ySize, int zSize, int wSize, int uSize) {
     ...
     * @return The integer value at (x, y, z, w, u).
     * @throws IndexOutOfBoundsException if coordinates are out of bounds.
     */
    public int get(int x, int y, int z, int w, int u) {
     ...
     * @throws IndexOutOfBoundsException if coordinates are out of bounds.
     */
    public void set(int x, int y, int z, int w, int u, int value) {
        checkBounds(x, y, z, w, u);
     ...
     * @return The integer value at (x, y, z, w, u).
     */
    public int getUnsafe(int x, int y, int z, int w, int u) {
        return data[(x * ySize * zSize * wSize * uSize) +
                    (y * zSize * wSize * uSize) +
                    (z * wSize * uSize) +
                    (w * uSize) +
     ...
     * @param value The integer value to set.
     */
    public void setUnsafe(int x, int y, int z, int w, int u, int value) {
        data[(x * ySize * zSize * wSize * uSize) +
             (y * zSize * wSize * uSize) +
             (z * wSize * uSize) +
             (w * uSize) +
    ...
    /**
     * Creates a copy of this Int5DArray.
     *
     * @return A new Int5DArray instance with copied data.
     */
    public Int5DArray copy() {
        Int5DArray copy = new Int5DArray(xSize, ySize, zSize, wSize, uSize);
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Int5DArray{\n");
