...
/**
 * Represents a four-dimensional array of integers.
 */
public class Int4DArray {
    ...
    /**
     * Constructs a 4D IntArray with the specified dimensions.
     *
     ...
     */
    public Int4DArray(int xSize, int ySize, int zSize, int wSize) {
     ...
     * @return The integer value at (x, y, z, w).
     ...
     * @return The integer value at (x, y, z, w).
     */
    public int getUnsafe(int x, int y, int z, int w) {
        return data[(x * ySize * zSize * wSize) + (y * zSize * wSize) + (z * wSize) + w];
    }
     ...
     * @param value The integer value to set.
     */
    public void setUnsafe(int x, int y, int z, int w, int value) {
        data[(x * ySize * zSize * wSize) + (y * zSize * wSize) + (z * wSize) + w] = value;
    }
    ...
    /**
     * Creates a copy of this Int4DArray.
     *
     * @return A new Int4DArray instance with copied data.
     */
    public Int4DArray copy() {
        Int4DArray copy = new Int4DArray(xSize, ySize, zSize, wSize);
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Int4DArray{\n");
