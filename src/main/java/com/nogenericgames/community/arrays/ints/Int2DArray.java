...
/**
 * Represents a two-dimensional array of integers.
 */
public class Int2DArray {
    ...
    /**
     * Constructs a 2D IntArray with the specified dimensions.
     *
     ...
     */
    public Int2DArray(int xSize, int ySize) {
        if (xSize <= 0 || ySize <= 0) {
     ...
     * @return The integer value at (x, y).
    ...
    /**
     * Creates a copy of this Int2DArray.
     *
     * @return A new Int2DArray instance with copied data.
     */
    public Int2DArray copy() {
        Int2DArray copy = new Int2DArray(xSize, ySize);
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Int2DArray{\n");
