...
/**
 * Represents a five-dimensional array of shorts.
 */
public class Short5DArray {
    ...
    /**
     * Constructs a 5D ShortArray with the specified dimensions.
     *
     ...
     */
    public Short5DArray(int xSize, int ySize, int zSize, int wSize, int uSize) {
     ...
     * @return The short value at (x, y, z, w, u).
     * @throws IndexOutOfBoundsException if coordinates are out of bounds.
     */
    public short get(int x, int y, int z, int w, int u) {
     ...
     * @throws IndexOutOfBoundsException if coordinates are out of bounds.
     */
    public void set(int x, int y, int z, int w, int u, short value) {
        checkBounds(x, y, z, w, u);
     ...
     * @return The short value at (x, y, z, w, u).
     */
    public short getUnsafe(int x, int y, int z, int w, int u) {
        return data[(x * ySize * zSize * wSize * uSize) +
                    (y * zSize * wSize * uSize) +
                    (z * wSize * uSize) +
                    (w * uSize) +
     ...
     * @param value The short value to set.
     */
    public void setUnsafe(int x, int y, int z, int w, int u, short value) {
        data[(x * ySize * zSize * wSize * uSize) +
             (y * zSize * wSize * uSize) +
             (z * wSize * uSize) +
             (w * uSize) +
    ...
    /**
     * Creates a copy of this Short5DArray.
     *
     * @return A new Short5DArray instance with copied data.
     */
    public Short5DArray copy() {
        Short5DArray copy = new Short5DArray(xSize, ySize, zSize, wSize, uSize);
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Short5DArray{\n");
    ...
    public boolean equals(Object o) {
        ...
        Short5DArray that = (Short5DArray) o;
