...
/**
 * Represents a five-dimensional array of doubles.
 */
public class Double5DArray {
    ...
    /**
     * Constructs a 5D DoubleArray with the specified dimensions.
     *
     ...
     */
    public Double5DArray(int xSize, int ySize, int zSize, int wSize, int uSize) {
     ...
     * @return The double value at (x, y, z, w, u).
     * @throws IndexOutOfBoundsException if coordinates are out of bounds.
     */
    public double get(int x, int y, int z, int w, int u) {
     ...
     * @throws IndexOutOfBoundsException if coordinates are out of bounds.
     */
    public void set(int x, int y, int z, int w, int u, double value) {
        checkBounds(x, y, z, w, u);
     ...
     * @return The double value at (x, y, z, w, u).
     */
    public double getUnsafe(int x, int y, int z, int w, int u) {
        return data[(x * ySize * zSize * wSize * uSize) +
                    (y * zSize * wSize * uSize) +
                    (z * wSize * uSize) +
                    (w * uSize) +
     ...
     * @param value The double value to set.
     */
    public void setUnsafe(int x, int y, int z, int w, int u, double value) {
        data[(x * ySize * zSize * wSize * uSize) +
             (y * zSize * wSize * uSize) +
             (z * wSize * uSize) +
             (w * uSize) +
    ...
    /**
     * Creates a copy of this Double5DArray.
     *
     * @return A new Double5DArray instance with copied data.
     */
    public Double5DArray copy() {
        Double5DArray copy = new Double5DArray(xSize, ySize, zSize, wSize, uSize);
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Double5DArray{\n");
    ...
    public boolean equals(Object o) {
        ...
        Double5DArray that = (Double5DArray) o;
