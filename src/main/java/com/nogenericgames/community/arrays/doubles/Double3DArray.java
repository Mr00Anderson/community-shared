...
/**
 * Represents a three-dimensional array of doubles.
 */
public class Double3DArray {
    ...
    /**
     * Constructs a 3D DoubleArray with the specified dimensions.
     *
     ...
     */
    public Double3DArray(int xSize, int ySize, int zSize) {
     ...
     * @return The double value at (x, y, z).
     ...
     * @return The double value at (x, y, z).
     */
    public double getUnsafe(int x, int y, int z) {
        return data[(x * ySize * zSize) + (y * zSize) + z];
    }
     ...
     * @param value The double value to set.
     */
    public void setUnsafe(int x, int y, int z, double value) {
        data[(x * ySize * zSize) + (y * zSize) + z] = value;
    }
    ...
    /**
     * Creates a copy of this Double3DArray.
     *
     * @return A new Double3DArray instance with copied data.
     */
    public Double3DArray copy() {
        Double3DArray copy = new Double3DArray(xSize, ySize, zSize);
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Double3DArray{\n");
    ...
    public boolean equals(Object o) {
        ...
        Double3DArray that = (Double3DArray) o;
