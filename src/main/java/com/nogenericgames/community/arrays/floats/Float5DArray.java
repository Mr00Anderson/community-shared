...
/**
 * Represents a five-dimensional array of floats.
 */
public class Float5DArray {
    ...
    /**
     * Constructs a 5D FloatArray with the specified dimensions.
     *
     ...
     */
    public Float5DArray(int xSize, int ySize, int zSize, int wSize, int uSize) {
     ...
     * @return The float value at (x, y, z, w, u).
    ...
    /**
     * Creates a copy of this Float5DArray.
     *
     * @return A new Float5DArray instance with copied data.
     */
    public Float5DArray copy() {
        Float5DArray copy = new Float5DArray(xSize, ySize, zSize, wSize, uSize);
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Float5DArray{\n");
    ...
    public boolean equals(Object o) {
        ...
        Float5DArray that = (Float5DArray) o;
